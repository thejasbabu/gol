##Description
To determine the next tick of conway's game of life,  which is an infinite two-dimensional orthogonal grid of square cells, each of which is in one of two possible states, live or dead.
##Dependencies
* JDK(1.6 or higher)
* Apache Ant
